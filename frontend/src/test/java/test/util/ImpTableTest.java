...
public class ImpTableTest {
    ...
    @Test
    public void testOneInsert() throws DuplicateException {
        ImpTable<Integer> tab = new ImpTable<Integer>();
        tab.put("x", 10);
    ...
    @Test
    public void testMultipleInsert() throws DuplicateException {
        ImpTable<Integer> tab = new ImpTable<Integer>();
        tab.put("x", 10);
        tab.put("y", 20);
        tab.put("z", 30);
    ...
    @Test
    public void testMultipleInsertOfSame() throws DuplicateException {
        ImpTable<Integer> tab = new ImpTable<Integer>();
        tab.put("x", 10);
        tab.put("y", 20);
        try {
