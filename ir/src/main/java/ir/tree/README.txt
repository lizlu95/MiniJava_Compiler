...
Here it is called minijava.ir.tree, which is more in keeping with Java's
naming conventions and a little more descriptive.

"ir.tree" stands for "Intermediate Representation Tree" (as opposed abstract syntax tree)
